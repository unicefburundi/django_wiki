...
SECRET_KEY = 'ntxxzp%w-j93fkts&1tu-x1^m(3y7cgp+ta!fl^1fug0p@p9g!'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = get_path('djangowiki/media/')
STATIC_URL = '/static/'
STATIC_ROOT = get_path('djangowiki/static/')

# Templates
TEMPLATE_DIRS = (
    get_path('djangowiki/templates/'),
)
